...
| 3   | **Database password was shared in a chat transcript**       | It now exists outside the password manager and outside `.env.local`                                                                                                                                                     | Rotate it in the Supabase dashboard and update `.env.local`                                                    | 🟠 High   |
