...
/**
 * The contact form. Loaded on demand by `ContactFormButton`. Started from a
 * company page the company is preset and the page stays put; from the contacts
 * list the new contact opens.
 */
